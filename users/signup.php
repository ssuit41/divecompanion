...
{     ?>
    ...
    <form method="post" action="">
		...
		Last Name : <input type="text" name="lname" value="<?php if(isset($_GET['editid'])){ echo  $lname;}?>" />
        Username: <input type="text" name="user_name" value="<?php if(isset($_GET['editid'])){ echo  $user;}?>" />
        <?php if(!isset($_GET['editid'])){ ?>
        Password: <input type="password" name="user_pass">
        Password again: <input type="password" name="user_pass_check"><?php } ?>
        E-mail: <input type="email" name="user_email" value="<?php if(isset($_GET['editid'])){ echo  $email;}?>">
		Phone Numbar : <input type="tel" name="phone" value="<?php if(isset($_GET['editid'])){ echo  $phone;}?>">
